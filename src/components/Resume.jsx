      ...
      <div className="container">
        ...
        <div className="row" style={{ marginTop: '1.5rem' }}>
          <div className="col-lg-12">
            <h3 className="resume-title" style={{ fontSize: '1.35rem', fontWeight: 600, marginBottom: '1rem', color: 'var(--primary)' }}>Professional Experience</h3>
        ...
        <div className="row" style={{ marginTop: '2rem' }}>
          <div className="col-lg-12">
            <h3 className="resume-title" style={{ fontSize: '1.35rem', fontWeight: 600, marginBottom: '1rem', color: 'var(--primary)' }}>Education</h3>
            <div className="resume-item">
